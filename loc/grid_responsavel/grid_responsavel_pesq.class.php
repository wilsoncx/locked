...
class grid_responsavel_pesq
{
    ...
    * @access  public
    */
   function grid_responsavel_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      global 
      $email_cond, $email,
             $idresponsavel_cond, $idresponsavel,
             $nome_cond, $nome,
             $celular_cond, $celular,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['email_cond']))
      {
          $email_cond = $this->NM_ajax_info['param']['email_cond'];
      }
      if (isset($this->NM_ajax_info['param']['email']))
      {
          $email = $this->NM_ajax_info['param']['email'];
      }
      if (isset($this->NM_ajax_info['param']['idresponsavel_cond']))
      {
          $idresponsavel_cond = $this->NM_ajax_info['param']['idresponsavel_cond'];
      }
      if (isset($this->NM_ajax_info['param']['idresponsavel']))
      {
          $idresponsavel = $this->NM_ajax_info['param']['idresponsavel'];
      }
      ...
      if (isset($this->NM_ajax_info['param']['celular_cond']))
      {
          $celular_cond = $this->NM_ajax_info['param']['celular_cond'];
      }
      if (isset($this->NM_ajax_info['param']['celular']))
      {
          $celular = $this->NM_ajax_info['param']['celular'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_responsavel_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_responsavel_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_responsavel_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_responsavel.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - responsavel</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_responsavel_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_responsavel_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_responsavel_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("grid_responsavel_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="grid_responsavel.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - responsavel</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $email = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['email']; 
          $email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['email_cond']; 
          $idresponsavel = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['idresponsavel']; 
          $idresponsavel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['idresponsavel_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['nome_cond']; 
          $celular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['celular']; 
          $celular_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['celular_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['NM_operador']; 
          if (strtoupper($idresponsavel_cond) != "II" && strtoupper($idresponsavel_cond) != "QP" && strtoupper($idresponsavel_cond) != "NP" && strtoupper($idresponsavel_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idresponsavel, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($idresponsavel_cond) || empty($idresponsavel_cond))
      {
         $idresponsavel_cond = "eq";
      }
      if (!isset($nome_cond) || empty($nome_cond))
      {
         $nome_cond = "eq";
      }
      if (!isset($celular_cond) || empty($celular_cond))
      {
         $celular_cond = "eq";
      }
      ...
      if (!isset($idresponsavel) || $idresponsavel == "")
      {
          $idresponsavel = "";
      }
      if (isset($idresponsavel) && !empty($idresponsavel))
      {
         $tmp_pos = strpos($idresponsavel, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idresponsavel = substr($idresponsavel, 0, $tmp_pos);
         }
      }
      if (!isset($nome) || $nome == "")
      {
      ...
      {
         $tmp_pos = strpos($celular, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $celular = substr($celular, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_responsavel_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="email_cond">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_email" name="email" value="<?php echo NM_encode_input($email) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['idresponsavel'])) ? $this->New_label['idresponsavel'] : "Idresponsavel"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="idresponsavel_cond">
       <OPTION value="eq" <?php if ("eq" == $idresponsavel_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $idresponsavel_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $idresponsavel_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $idresponsavel_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "idresponsavel?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_idresponsavel" name="idresponsavel" value="<?php echo NM_encode_input($idresponsavel) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_nome" name="nome" value="<?php echo NM_encode_input($nome) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['celular'])) ? $this->New_label['celular'] : "Celular"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="celular_cond">
       <OPTION value="eq" <?php if ("eq" == $celular_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $celular_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $celular_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $celular_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "celular?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_celular" name="celular" value="<?php echo NM_encode_input($celular) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_responsavel']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_responsavel']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_responsavel.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idresponsavel.value = "";
   document.F1.nome.value = "";
   document.F1.celular.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Locked/grid_responsavel";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_responsavel']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($idresponsavel_cond != "in")
          {
              nm_limpa_numero($idresponsavel, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $idresponsavel);
              ...
              $idresponsavel = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($email_cond)) ? $email_cond : ""; 
          $NM_str_filter .= "email_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($email)) ? $email : ""; 
          $NM_str_filter .= "email#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($idresponsavel_cond)) ? $idresponsavel_cond : ""; 
          $NM_str_filter .= "idresponsavel_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($idresponsavel)) ? $idresponsavel : ""; 
          $NM_str_filter .= "idresponsavel#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_temp  = (isset($celular_cond)) ? $celular_cond : ""; 
          $NM_str_filter .= "celular_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($celular)) ? $celular : ""; 
          $NM_str_filter .= "celular#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_responsavel']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['email_cond'] = 'select';
      $tp_html['idresponsavel_cond'] = 'select';
      $tp_html['nome_cond'] = 'select';
      $tp_html['celular_cond'] = 'select';
      $tp_html['email'] = 'text';
      $tp_html['idresponsavel'] = 'text';
      $tp_html['nome'] = 'text';
      $tp_html['celular'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "idresponsavel_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "idresponsavel")
                  {
                      if (strtoupper($idresponsavel_cond) != "II" && strtoupper($idresponsavel_cond) != "QP" && strtoupper($idresponsavel_cond) != "NP" && strtoupper($idresponsavel_cond) != "IN") 
                      { 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_responsavel_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_responsavel_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $email_cond, $email,
             $idresponsavel_cond, $idresponsavel,
             $nome_cond, $nome,
             $celular_cond, $celular, $nmgp_tab_label;
      ...
      $idresponsavel_cond_salva = $idresponsavel_cond; 
      if (!isset($idresponsavel_input_2) || $idresponsavel_input_2 == "")
      {
          $idresponsavel_input_2 = $idresponsavel;
      }
      ...
      $celular_cond_salva = $celular_cond; 
      if (!isset($celular_input_2) || $celular_input_2 == "")
      {
          $celular_input_2 = $celular;
      }
      if ($idresponsavel_cond != "in")
      {
          nm_limpa_numero($idresponsavel, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['email'] = $email; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['email_cond'] = $email_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['idresponsavel'] = $idresponsavel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['idresponsavel_cond'] = $idresponsavel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['nome'] = $nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['celular'] = $celular; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['celular_cond'] = $celular_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $email;
      $this->cmp_formatado['email'] = $Conteudo;
      $Conteudo = $idresponsavel;
      if (strtoupper($idresponsavel_cond) != "II" && strtoupper($idresponsavel_cond) != "QP" && strtoupper($idresponsavel_cond) != "NP" && strtoupper($idresponsavel_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idresponsavel'] = $Conteudo;
      $Conteudo = $nome;
      $this->cmp_formatado['nome'] = $Conteudo;
      $Conteudo = $celular;
      $this->cmp_formatado['celular'] = $Conteudo;

      //----- $email
      if (isset($email) || $email_cond == "nu" || $email_cond == "nn")
      {
         $this->monta_condicao("email", $email_cond, $email, "", "email");
      }

      //----- $idresponsavel
      if (isset($idresponsavel) || $idresponsavel_cond == "nu" || $idresponsavel_cond == "nn")
      {
         $this->monta_condicao("idresponsavel", $idresponsavel_cond, $idresponsavel, "", "idresponsavel");
      }
      ...
      //----- $celular
      if (isset($celular) || $celular_cond == "nu" || $celular_cond == "nn")
      {
         $this->monta_condicao("celular", $celular_cond, $celular, "", "celular");
      }
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['where_pesq_ant'] = $this->comando . $this->comando_fim;
