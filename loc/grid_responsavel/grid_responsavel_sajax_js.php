  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_responsavel" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_responsavel_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_email_cond = scAjaxGetFieldSelect("email_cond");
    var var_email = scAjaxGetFieldText("email");
    var var_idresponsavel_cond = scAjaxGetFieldSelect("idresponsavel_cond");
    var var_idresponsavel = scAjaxGetFieldText("idresponsavel");
    var var_nome_cond = scAjaxGetFieldSelect("nome_cond");
    var var_nome = scAjaxGetFieldText("nome");
    var var_celular_cond = scAjaxGetFieldSelect("celular_cond");
    ...
    x_grid_responsavel_ajax_save_filter( var_email_cond, var_email, var_idresponsavel_cond, var_idresponsavel, var_nome_cond, var_nome, var_celular_cond, var_celular, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_responsavel_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_responsavel_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_responsavel_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_responsavel_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_responsavel_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_responsavel_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_responsavel_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_responsavel_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_responsavel_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_responsavel_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "idresponsavel";
  ajax_field_list[2] = "nome";
  ajax_field_list[3] = "celular";

  var ajax_error_list = {
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "idresponsavel": {"label": "Idresponsavel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "nome": {"label": "Nome", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "celular": {"label": "Celular", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
