...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Locked_____grid_responsavel"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Locked_____grid_responsavel"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_responsavel'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_responsavel']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_responsavel']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_responsavel']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_responsavel']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_responsavel']['sc_modal']);
