...
class grid_responsavel_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_responsavel.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['rtf_name']);
      }
   ...
   function NM_export_idresponsavel()
   {
         ...
         if (!NM_is_utf8($this->idresponsavel))
         {
          ...
          $this->idresponsavel = str_replace('<', '&lt;', $this->idresponsavel);
          $this->idresponsavel = str_replace('>', '&gt;', $this->idresponsavel);
         $this->texto_tag .= "<td>" . $this->idresponsavel . "</td>\r\n";
   }
   //----- nome
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - responsavel :: RTF</TITLE>
