...
class grid_responsavel_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_responsavel.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_responsavel";
   ...
   function NM_export_idresponsavel()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idresponsavel))
         {
             $this->idresponsavel = mb_convert_encoding($this->idresponsavel, "UTF-8");
         }
         $this->xml_registro .= " idresponsavel =\"" . $this->trata_dados($this->idresponsavel) . "\"";
   }
   //----- nome
   ...
   function NM_export_celular()
   {
         ...
         {
             $this->celular = mb_convert_encoding($this->celular, "UTF-8");
         }
         $this->xml_registro .= " celular =\"" . $this->trata_dados($this->celular) . "\"";
   }
   //----- email
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsavel']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - responsavel :: XML</TITLE>
...
<FORM name="F0" method=post action="grid_responsavel.php" style="display: none"> 
