...
class grid_aluno_xml
{
   ...
   function NM_export_idaluno()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idaluno))
         {
             $this->idaluno = mb_convert_encoding($this->idaluno, "UTF-8");
         }
         $this->xml_registro .= " idaluno =\"" . $this->trata_dados($this->idaluno) . "\"";
   }
   //----- idcarteira
   function NM_export_idcarteira()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idcarteira))
         {
             $this->idcarteira = mb_convert_encoding($this->idcarteira, "UTF-8");
         }
         $this->xml_registro .= " idcarteira =\"" . $this->trata_dados($this->idcarteira) . "\"";
   }
   //----- nome
   ...
   function NM_export_data_nasc()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->data_nasc))
         {
             $this->data_nasc = mb_convert_encoding($this->data_nasc, "UTF-8");
         }
         $this->xml_registro .= " data_nasc =\"" . $this->trata_dados($this->data_nasc) . "\"";
   }
   //----- turma
   function NM_export_turma()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->turma))
         {
             $this->turma = mb_convert_encoding($this->turma, "UTF-8");
         }
         $this->xml_registro .= " turma =\"" . $this->trata_dados($this->turma) . "\"";
   }
...
<FORM name="F0" method=post action="grid_aluno.php" style="display: none"> 
