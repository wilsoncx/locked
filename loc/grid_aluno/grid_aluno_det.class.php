...
class grid_aluno_det
{
 ...
 function monta_det()
 {
   ...
   $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
       $nmgp_select = "SELECT foto, idaluno, idcarteira, nome, sexo, turma from " . $this->Ini->nm_tabela; 
   $parms_det = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['chave_det']) ; 
   ...
   $nmgp_select .= " where  idaluno = $parms_det[0]" ;  
   ...
   $this->foto = $rs->fields[0] ;  
   $this->idaluno = $rs->fields[1] ;  
...
//--- 
   ...
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - aluno</TITLE>\r\n");
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"scGridHeaderFont\"><span>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - aluno</span></td>\r\n");
   ...
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          ...
          { 
              $out_foto = $this->Ini->path_imag_temp . "/sc_" . "foto_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".gif" ; 
          ...
          if (!empty($out_foto)) 
          { 
             $conteudo = "<a href=\"javascript:nm_mostra_img('" . $out_foto . "', '$img_alt', '$img_larg')\"><img border=\"0\" src=\"$out_foto\"></a>"; 
          }  
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_aluno/grid_aluno.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "\";\r\n");
   $nm_saida->saida("   }\r\n");
