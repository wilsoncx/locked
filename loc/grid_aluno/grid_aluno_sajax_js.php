  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_aluno" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_aluno_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_data_nasc_cond = scAjaxGetFieldSelect("data_nasc_cond");
    var var_data_nasc_dia = scAjaxGetFieldText("data_nasc_dia");
    var var_data_nasc_mes = scAjaxGetFieldText("data_nasc_mes");
    var var_data_nasc_ano = scAjaxGetFieldText("data_nasc_ano");
    var var_data_nasc_hor = scAjaxGetFieldText("data_nasc_hor");
    var var_data_nasc_min = scAjaxGetFieldText("data_nasc_min");
    var var_data_nasc_seg = scAjaxGetFieldText("data_nasc_seg");
    var var_idaluno_cond = scAjaxGetFieldSelect("idaluno_cond");
    var var_idaluno = scAjaxGetFieldText("idaluno");
    var var_nome_cond = scAjaxGetFieldSelect("nome_cond");
    var var_nome = scAjaxGetFieldText("nome");
    var var_sexo_cond = scAjaxGetFieldSelect("sexo_cond");
    ...
    x_grid_aluno_ajax_save_filter( var_data_nasc_cond, var_data_nasc_dia, var_data_nasc_mes, var_data_nasc_ano, var_data_nasc_hor, var_data_nasc_min, var_data_nasc_seg, var_idaluno_cond, var_idaluno, var_nome_cond, var_nome, var_sexo_cond, var_sexo, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_aluno_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_aluno_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_aluno_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_aluno_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_aluno_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_aluno_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_aluno_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_aluno_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_aluno_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_aluno_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "data_nasc";
  ajax_field_list[1] = "idaluno";
  ajax_field_list[2] = "nome";
  ajax_field_list[3] = "sexo";

  var ajax_error_list = {
    "data_nasc": {"label": "Data Nascimento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "idaluno": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "nome": {"label": "Nome", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "sexo": {"label": "Sexo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
