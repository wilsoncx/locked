...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_def_campos['idaluno'] = "idaluno";
   $tab_converte["idaluno"]   = "idaluno";
   $tab_ger_campos['idcarteira'] = "on";
   $tab_def_campos['idcarteira'] = "idcarteira";
   $tab_converte["idcarteira"]   = "idcarteira";
   ...
   $tab_def_campos['data_nasc'] = "data_nasc";
   $tab_converte["data_nasc"]   = "data_nasc";
   $tab_ger_campos['turma'] = "on";
   $tab_def_campos['turma'] = "turma";
   $tab_converte["turma"]   = "turma";
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
