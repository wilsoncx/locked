...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Locked_____grid_liberacao_X_aluno"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Locked_____grid_liberacao_X_aluno"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_liberacao_X_aluno'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_liberacao_X_aluno</TITLE>
