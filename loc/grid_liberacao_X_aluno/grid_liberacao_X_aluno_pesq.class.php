...
class grid_liberacao_X_aluno_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_liberacao_X_aluno_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   {
      global 
      $liberacao_cond, $liberacao,
             $aluno_cond, $aluno,
             $idliberacao_x_aluno_cond, $idliberacao_x_aluno,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['liberacao_cond']))
      {
          $liberacao_cond = $this->NM_ajax_info['param']['liberacao_cond'];
      }
      if (isset($this->NM_ajax_info['param']['liberacao']))
      {
          $liberacao = $this->NM_ajax_info['param']['liberacao'];
      }
      if (isset($this->NM_ajax_info['param']['aluno_cond']))
      {
          $aluno_cond = $this->NM_ajax_info['param']['aluno_cond'];
      }
      if (isset($this->NM_ajax_info['param']['aluno']))
      {
          $aluno = $this->NM_ajax_info['param']['aluno'];
      }
      if (isset($this->NM_ajax_info['param']['idliberacao_x_aluno_cond']))
      {
          $idliberacao_x_aluno_cond = $this->NM_ajax_info['param']['idliberacao_x_aluno_cond'];
      }
      if (isset($this->NM_ajax_info['param']['idliberacao_x_aluno']))
      {
          $idliberacao_x_aluno = $this->NM_ajax_info['param']['idliberacao_x_aluno'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_liberacao_X_aluno_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_liberacao_X_aluno_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_liberacao_X_aluno_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "liberacao_X_aluno.$nome";
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_liberacao_X_aluno.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - liberacao_X_aluno</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_liberacao_X_aluno_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_liberacao_X_aluno_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_liberacao_X_aluno_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("grid_liberacao_X_aluno_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="grid_liberacao_X_aluno.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - liberacao_X_aluno</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $liberacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['liberacao']; 
          $liberacao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['liberacao_cond']; 
          $aluno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['aluno']; 
          $aluno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['aluno_cond']; 
          $idliberacao_x_aluno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['idliberacao_x_aluno']; 
          $idliberacao_x_aluno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['idliberacao_x_aluno_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['NM_operador']; 
          if (strtoupper($liberacao_cond) != "II" && strtoupper($liberacao_cond) != "QP" && strtoupper($liberacao_cond) != "NP" && strtoupper($liberacao_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($liberacao, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($aluno_cond) != "II" && strtoupper($aluno_cond) != "QP" && strtoupper($aluno_cond) != "NP" && strtoupper($aluno_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($aluno, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idliberacao_x_aluno_cond) != "II" && strtoupper($idliberacao_x_aluno_cond) != "QP" && strtoupper($idliberacao_x_aluno_cond) != "NP" && strtoupper($idliberacao_x_aluno_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idliberacao_x_aluno, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($liberacao_cond) || empty($liberacao_cond))
      {
         $liberacao_cond = "eq";
      }
      if (!isset($aluno_cond) || empty($aluno_cond))
      {
         $aluno_cond = "eq";
      }
      if (!isset($idliberacao_x_aluno_cond) || empty($idliberacao_x_aluno_cond))
      {
         $idliberacao_x_aluno_cond = "eq";
      }
      if (!isset($liberacao) || $liberacao == "")
      {
          $liberacao = "";
      }
      if (isset($liberacao) && !empty($liberacao))
      {
         $tmp_pos = strpos($liberacao, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $liberacao = substr($liberacao, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($aluno, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $aluno = substr($aluno, 0, $tmp_pos);
         }
      }
      if (!isset($idliberacao_x_aluno) || $idliberacao_x_aluno == "")
      {
          $idliberacao_x_aluno = "";
      }
      if (isset($idliberacao_x_aluno) && !empty($idliberacao_x_aluno))
      {
         $tmp_pos = strpos($idliberacao_x_aluno, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idliberacao_x_aluno = substr($idliberacao_x_aluno, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_liberacao_X_aluno_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['liberacao'])) ? $this->New_label['liberacao'] : "Liberacao"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="liberacao_cond">
       <OPTION value="eq" <?php if ("eq" == $liberacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $liberacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $liberacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $liberacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
 ...
 $nmgp_tab_label .= "liberacao?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_liberacao" name="liberacao" value="<?php echo NM_encode_input($liberacao) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['aluno'])) ? $this->New_label['aluno'] : "Aluno"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="aluno_cond">
       <OPTION value="eq" <?php if ("eq" == $aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "aluno?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_aluno" name="aluno" value="<?php echo NM_encode_input($aluno) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idliberacao_x_aluno'])) ? $this->New_label['idliberacao_x_aluno'] : "Idliberacao X Aluno"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="idliberacao_x_aluno_cond">
       <OPTION value="eq" <?php if ("eq" == $idliberacao_x_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $idliberacao_x_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $idliberacao_x_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $idliberacao_x_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "idliberacao_x_aluno?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_idliberacao_x_aluno" name="idliberacao_x_aluno" value="<?php echo NM_encode_input($idliberacao_x_aluno) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_liberacao_X_aluno']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_liberacao_X_aluno']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_liberacao_X_aluno.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.liberacao.value = "";
   document.F1.aluno.value = "";
   document.F1.idliberacao_x_aluno.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Locked/grid_liberacao_X_aluno";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($liberacao_cond != "in")
          {
              nm_limpa_numero($liberacao, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $liberacao);
              ...
              $liberacao = implode(",", $Nm_sc_valores);
          }
          if ($aluno_cond != "in")
          {
              nm_limpa_numero($aluno, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $aluno);
              foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
              {
                  $Nm_sc_valor = trim($Nm_sc_valor);
                  nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
              ...
              $aluno = implode(",", $Nm_sc_valores);
          }
          if ($idliberacao_x_aluno_cond != "in")
          {
              nm_limpa_numero($idliberacao_x_aluno, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $idliberacao_x_aluno);
              foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
              {
                  $Nm_sc_valor = trim($Nm_sc_valor);
                  nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
              ...
              $idliberacao_x_aluno = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($liberacao_cond)) ? $liberacao_cond : ""; 
          $NM_str_filter .= "liberacao_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($liberacao)) ? $liberacao : ""; 
          $NM_str_filter .= "liberacao#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($aluno_cond)) ? $aluno_cond : ""; 
          $NM_str_filter .= "aluno_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($aluno)) ? $aluno : ""; 
          $NM_str_filter .= "aluno#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($idliberacao_x_aluno_cond)) ? $idliberacao_x_aluno_cond : ""; 
          $NM_str_filter .= "idliberacao_x_aluno_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($idliberacao_x_aluno)) ? $idliberacao_x_aluno : ""; 
          $NM_str_filter .= "idliberacao_x_aluno#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_patch .= "grid_liberacao_X_aluno/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_liberacao_X_aluno']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['liberacao_cond'] = 'select';
      $tp_html['aluno_cond'] = 'select';
      $tp_html['idliberacao_x_aluno_cond'] = 'select';
      $tp_html['liberacao'] = 'text';
      $tp_html['aluno'] = 'text';
      $tp_html['idliberacao_x_aluno'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "liberacao_cond" || $Cada_cmp[0] == "aluno_cond" || $Cada_cmp[0] == "idliberacao_x_aluno_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "liberacao")
                  {
                      if (strtoupper($liberacao_cond) != "II" && strtoupper($liberacao_cond) != "QP" && strtoupper($liberacao_cond) != "NP" && strtoupper($liberacao_cond) != "IN") 
                      { 
                  ...
                  if ($SC_V6 && $Cada_cmp[0] == "idliberacao_x_aluno")
                  {
                      if (strtoupper($idliberacao_x_aluno_cond) != "II" && strtoupper($idliberacao_x_aluno_cond) != "QP" && strtoupper($idliberacao_x_aluno_cond) != "NP" && strtoupper($idliberacao_x_aluno_cond) != "IN") 
                      { 
                          nmgp_Form_Num_Val($Cada_cmp[1], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_liberacao_X_aluno_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_liberacao_X_aluno_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $liberacao_cond, $liberacao,
             $aluno_cond, $aluno,
             $idliberacao_x_aluno_cond, $idliberacao_x_aluno, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $liberacao_cond_salva = $liberacao_cond; 
      if (!isset($liberacao_input_2) || $liberacao_input_2 == "")
      {
          $liberacao_input_2 = $liberacao;
      }
      $aluno_cond_salva = $aluno_cond; 
      if (!isset($aluno_input_2) || $aluno_input_2 == "")
      {
          $aluno_input_2 = $aluno;
      }
      $idliberacao_x_aluno_cond_salva = $idliberacao_x_aluno_cond; 
      if (!isset($idliberacao_x_aluno_input_2) || $idliberacao_x_aluno_input_2 == "")
      {
          $idliberacao_x_aluno_input_2 = $idliberacao_x_aluno;
      }
      if ($liberacao_cond != "in")
      {
          nm_limpa_numero($liberacao, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['liberacao'] = $liberacao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['liberacao_cond'] = $liberacao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['aluno'] = $aluno; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['aluno_cond'] = $aluno_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['idliberacao_x_aluno'] = $idliberacao_x_aluno; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['idliberacao_x_aluno_cond'] = $idliberacao_x_aluno_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $liberacao;
      if (strtoupper($liberacao_cond) != "II" && strtoupper($liberacao_cond) != "QP" && strtoupper($liberacao_cond) != "NP" && strtoupper($liberacao_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['liberacao'] = $Conteudo;
      $Conteudo = $aluno;
      if (strtoupper($aluno_cond) != "II" && strtoupper($aluno_cond) != "QP" && strtoupper($aluno_cond) != "NP" && strtoupper($aluno_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['aluno'] = $Conteudo;
      $Conteudo = $idliberacao_x_aluno;
      if (strtoupper($idliberacao_x_aluno_cond) != "II" && strtoupper($idliberacao_x_aluno_cond) != "QP" && strtoupper($idliberacao_x_aluno_cond) != "NP" && strtoupper($idliberacao_x_aluno_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idliberacao_x_aluno'] = $Conteudo;

      //----- $liberacao
      if (isset($liberacao) || $liberacao_cond == "nu" || $liberacao_cond == "nn")
      {
         $this->monta_condicao("liberacao", $liberacao_cond, $liberacao, "", "liberacao");
      }

      //----- $aluno
      if (isset($aluno) || $aluno_cond == "nu" || $aluno_cond == "nn")
      {
         $this->monta_condicao("aluno", $aluno_cond, $aluno, "", "aluno");
      }

      //----- $idliberacao_x_aluno
      if (isset($idliberacao_x_aluno) || $idliberacao_x_aluno_cond == "nu" || $idliberacao_x_aluno_cond == "nn")
      {
         $this->monta_condicao("idliberacao_X_aluno", $idliberacao_x_aluno_cond, $idliberacao_x_aluno, "", "idliberacao_x_aluno");
      }
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['where_pesq_ant'] = $this->comando . $this->comando_fim;
