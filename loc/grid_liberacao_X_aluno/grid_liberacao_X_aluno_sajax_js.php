  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_liberacao_X_aluno" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_liberacao_X_aluno_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_liberacao_cond = scAjaxGetFieldSelect("liberacao_cond");
    var var_liberacao = scAjaxGetFieldText("liberacao");
    var var_aluno_cond = scAjaxGetFieldSelect("aluno_cond");
    var var_aluno = scAjaxGetFieldText("aluno");
    var var_idliberacao_x_aluno_cond = scAjaxGetFieldSelect("idliberacao_x_aluno_cond");
    var var_idliberacao_x_aluno = scAjaxGetFieldText("idliberacao_x_aluno");
    ...
    x_grid_liberacao_X_aluno_ajax_save_filter( var_liberacao_cond, var_liberacao, var_aluno_cond, var_aluno, var_idliberacao_x_aluno_cond, var_idliberacao_x_aluno, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_liberacao_X_aluno_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_liberacao_X_aluno_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_liberacao_X_aluno_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_liberacao_X_aluno_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_liberacao_X_aluno_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_liberacao_X_aluno_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_liberacao_X_aluno_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_liberacao_X_aluno_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_liberacao_X_aluno_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_liberacao_X_aluno_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  var ajax_error_list = {
    "liberacao": {"label": "Liberacao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "aluno": {"label": "Aluno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "idliberacao_x_aluno": {"label": "Idliberacao X Aluno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
