...
class grid_liberacao_X_aluno_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $tit_doc;
   //---- 
   function grid_liberacao_X_aluno_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grid_liberacao_X_aluno.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
      ...
      { 
          ...
          if ($Cada_col == "liberacao" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
          ...
          if ($Cada_col == "idliberacao_x_aluno" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
   ...
   {
         if (!NM_is_utf8($this->liberacao))
         {
             $this->liberacao = mb_convert_encoding($this->liberacao, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->liberacao))
         {
             $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->liberacao);
         $this->xls_col++;
   }
   //----- aluno
   function NM_export_aluno()
   {
         ...
         {
             $this->aluno = mb_convert_encoding($this->aluno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         ...
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->aluno);
         $this->xls_col++;
   }
   //----- idliberacao_x_aluno
   function NM_export_idliberacao_x_aluno()
   {
         if (!NM_is_utf8($this->idliberacao_x_aluno))
         {
             $this->idliberacao_x_aluno = mb_convert_encoding($this->idliberacao_x_aluno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->idliberacao_x_aluno))
         {
             $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->idliberacao_x_aluno);
         $this->xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['xls_file'] = $this->xls_f;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - liberacao_X_aluno :: Excel</TITLE>
