...
class grid_liberacao_X_aluno_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_liberacao_X_aluno_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_liberacao_X_aluno.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['rtf_name']);
      }
   ...
   function NM_export_liberacao()
   {
         ...
         if (!NM_is_utf8($this->liberacao))
         {
          ...
          $this->liberacao = str_replace('<', '&lt;', $this->liberacao);
          $this->liberacao = str_replace('>', '&gt;', $this->liberacao);
         $this->texto_tag .= "<td>" . $this->liberacao . "</td>\r\n";
   }
   //----- aluno
   ...
   function NM_export_idliberacao_x_aluno()
   {
         ...
         if (!NM_is_utf8($this->idliberacao_x_aluno))
         {
          ...
          $this->idliberacao_x_aluno = str_replace('<', '&lt;', $this->idliberacao_x_aluno);
          $this->idliberacao_x_aluno = str_replace('>', '&gt;', $this->idliberacao_x_aluno);
         $this->texto_tag .= "<td>" . $this->idliberacao_x_aluno . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - liberacao_X_aluno :: RTF</TITLE>
