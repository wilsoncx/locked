...
class grid_liberacao_X_aluno_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_liberacao_X_aluno_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->arquivo    .= ".csv";
      $this->tit_doc    = "grid_liberacao_X_aluno.csv";
      $this->delim_dados = "\"";
      $this->delim_col   = ";";
      $this->delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['csv_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['csv_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['csv_name']);
      }
   ...
   function NM_export_liberacao()
   {
      ...
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->liberacao);
   ...
   function NM_export_idliberacao_x_aluno()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->delim_col : "";
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->idliberacao_x_aluno);
      $this->csv_registro .= $col_sep . $this->delim_dados . $conteudo . $this->delim_dados;
      $this->NM_prim_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao_X_aluno']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - liberacao_X_aluno :: CSV</TITLE>
