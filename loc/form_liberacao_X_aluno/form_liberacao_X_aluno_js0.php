<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="idliberacao_x_aluno" value="<?php echo NM_encode_input($this->nmgp_dados_form['idliberacao_x_aluno']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_liberacao_X_aluno']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
