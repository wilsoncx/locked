  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_liberacao_X_aluno" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate liberacao
  function do_ajax_form_liberacao_X_aluno_validate_liberacao()
  {
    var nomeCampo_liberacao = "liberacao";
    var var_liberacao = scAjaxGetFieldSelect(nomeCampo_liberacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_liberacao_X_aluno_validate_liberacao(var_liberacao, var_script_case_init, do_ajax_form_liberacao_X_aluno_validate_liberacao_cb);
  } // do_ajax_form_liberacao_X_aluno_validate_liberacao

  function do_ajax_form_liberacao_X_aluno_validate_liberacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "liberacao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_liberacao_X_aluno_validate_liberacao_cb

  // ---------- Validate aluno
  function do_ajax_form_liberacao_X_aluno_validate_aluno()
  {
    var nomeCampo_aluno = "aluno";
    var var_aluno = scAjaxGetFieldSelect(nomeCampo_aluno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_liberacao_X_aluno_validate_aluno(var_aluno, var_script_case_init, do_ajax_form_liberacao_X_aluno_validate_aluno_cb);
  } // do_ajax_form_liberacao_X_aluno_validate_aluno

  function do_ajax_form_liberacao_X_aluno_validate_aluno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "aluno";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_liberacao_X_aluno_validate_aluno_cb

  // ---------- Validate idliberacao_x_aluno
  function do_ajax_form_liberacao_X_aluno_validate_idliberacao_x_aluno()
  {
    var nomeCampo_idliberacao_x_aluno = "idliberacao_x_aluno";
    var var_idliberacao_x_aluno = scAjaxGetFieldHidden(nomeCampo_idliberacao_x_aluno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_liberacao_X_aluno_validate_idliberacao_x_aluno(var_idliberacao_x_aluno, var_script_case_init, do_ajax_form_liberacao_X_aluno_validate_idliberacao_x_aluno_cb);
  } // do_ajax_form_liberacao_X_aluno_validate_idliberacao_x_aluno

  function do_ajax_form_liberacao_X_aluno_validate_idliberacao_x_aluno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idliberacao_x_aluno";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_liberacao_X_aluno_validate_idliberacao_x_aluno_cb
  // ---------- Form
  function do_ajax_form_liberacao_X_aluno_submit_form()
  {
    scAjaxHideMessage();
    var var_liberacao = scAjaxGetFieldSelect("liberacao");
    var var_aluno = scAjaxGetFieldSelect("aluno");
    var var_idliberacao_x_aluno = scAjaxGetFieldHidden("idliberacao_x_aluno");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_liberacao_X_aluno_submit_form(var_liberacao, var_aluno, var_idliberacao_x_aluno, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_liberacao_X_aluno_submit_form_cb);
  } // do_ajax_form_liberacao_X_aluno_submit_form

  function do_ajax_form_liberacao_X_aluno_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("liberacao");
      scAjaxHideErrorDisplay("aluno");
      scAjaxHideErrorDisplay("idliberacao_x_aluno");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_liberacao_X_aluno_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_liberacao_X_aluno_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("aluno");
    scAjaxHideErrorDisplay("idliberacao_x_aluno");
    var var_idliberacao_x_aluno = document.F2.idliberacao_x_aluno.value;
    ...
    scAjaxProcOn();
    x_ajax_form_liberacao_X_aluno_navigate_form(var_idliberacao_x_aluno, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_liberacao_X_aluno_navigate_form_cb);
  } // do_ajax_form_liberacao_X_aluno_navigate_form

  function do_ajax_form_liberacao_X_aluno_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idliberacao_x_aluno.value = scAjaxGetKeyValue("idliberacao_x_aluno");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_liberacao_X_aluno_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_liberacao_X_aluno_navigate_form_cb
  ...
  ajax_field_list[0] = "liberacao";
  ajax_field_list[1] = "aluno";
  ajax_field_list[2] = "idliberacao_x_aluno";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "liberacao": {"label": "Liberacao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aluno": {"label": "Aluno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idliberacao_x_aluno": {"label": "Idliberacao X Aluno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "liberacao": new Array(),
    "aluno": new Array(),
    "idliberacao_x_aluno": new Array()
  };
  ajax_field_mult["liberacao"][1] = "liberacao";
  ajax_field_mult["aluno"][1] = "aluno";
  ajax_field_mult["idliberacao_x_aluno"][1] = "idliberacao_x_aluno";

  var ajax_field_id = {
    "liberacao": new Array("hidden_field_label_liberacao", "hidden_field_data_liberacao"),
    "aluno": new Array("hidden_field_label_aluno", "hidden_field_data_aluno"),
    "idliberacao_x_aluno": new Array("hidden_field_label_idliberacao_x_aluno", "hidden_field_data_idliberacao_x_aluno")
  };

  var ajax_read_only = {
    "liberacao": "off",
    "aluno": "off",
    "idliberacao_x_aluno": "on"
  };
