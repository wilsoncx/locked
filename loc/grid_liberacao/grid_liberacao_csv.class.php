...
class grid_liberacao_csv
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->arquivo    .= ".csv";
      $this->tit_doc    = "grid_liberacao.csv";
      $this->delim_dados = "\"";
      $this->delim_col   = ";";
      $this->delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['csv_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['csv_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['csv_name']);
      }
   ...
   function NM_export_idliberacao()
   {
      ...
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->idliberacao);
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - liberacao :: CSV</TITLE>
