...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Locked_____grid_liberacao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Locked_____grid_liberacao"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_liberacao'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_liberacao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_liberacao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_liberacao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_liberacao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_liberacao']['sc_modal']);
