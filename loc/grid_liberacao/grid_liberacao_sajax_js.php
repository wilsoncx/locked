  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_liberacao" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_liberacao_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_motivo_cond = scAjaxGetFieldSelect("motivo_cond");
    var var_motivo = scAjaxGetFieldText("motivo");
    var var_idliberacao_cond = scAjaxGetFieldSelect("idliberacao_cond");
    var var_idliberacao = scAjaxGetFieldText("idliberacao");
    var var_hora_cond = scAjaxGetFieldSelect("hora_cond");
    var var_hora_hor = scAjaxGetFieldText("hora_hor");
    var var_hora_min = scAjaxGetFieldText("hora_min");
    var var_hora_seg = scAjaxGetFieldText("hora_seg");
    var var_dia_cond = scAjaxGetFieldSelect("dia_cond");
    var var_dia_dia = scAjaxGetFieldText("dia_dia");
    var var_dia_mes = scAjaxGetFieldText("dia_mes");
    var var_dia_ano = scAjaxGetFieldText("dia_ano");
    ...
    x_grid_liberacao_ajax_save_filter( var_motivo_cond, var_motivo, var_idliberacao_cond, var_idliberacao, var_hora_cond, var_hora_hor, var_hora_min, var_hora_seg, var_dia_cond, var_dia_dia, var_dia_mes, var_dia_ano, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_liberacao_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_liberacao_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_liberacao_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_liberacao_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_liberacao_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_liberacao_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_liberacao_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_liberacao_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_liberacao_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_liberacao_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "motivo";
  ajax_field_list[1] = "idliberacao";
  ajax_field_list[2] = "hora";
  ajax_field_list[3] = "dia";

  var ajax_error_list = {
    "motivo": {"label": "Motivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "idliberacao": {"label": "Idliberacao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "hora": {"label": "Hora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
