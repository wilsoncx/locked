...
class grid_liberacao_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_liberacao.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['rtf_name']);
      }
   ...
   function NM_export_idliberacao()
   {
         ...
         if (!NM_is_utf8($this->idliberacao))
         {
          ...
          $this->idliberacao = str_replace('<', '&lt;', $this->idliberacao);
          $this->idliberacao = str_replace('>', '&gt;', $this->idliberacao);
         $this->texto_tag .= "<td>" . $this->idliberacao . "</td>\r\n";
   }
   //----- hora
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - liberacao :: RTF</TITLE>
