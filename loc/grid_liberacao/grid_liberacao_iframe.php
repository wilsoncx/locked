...
$oExportPdf = new grid_liberacao_export_pdf;
$oExportPdf->exportPdf();

class grid_liberacao_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - liberacao :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_liberacao_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_liberacao']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_liberacao']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_liberacao.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_liberacao']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_liberacao']['pdf_name'] : "grid_liberacao.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="grid_liberacao.php" target="<?php echo $NM_target; ?>" style="display: none"> 
