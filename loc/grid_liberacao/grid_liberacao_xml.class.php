...
class grid_liberacao_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_liberacao.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_liberacao";
   ...
   {
         nmgp_Form_Num_Val($this->idliberacao, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->idliberacao))
         {
             $this->idliberacao = mb_convert_encoding($this->idliberacao, "UTF-8");
         }
         $this->xml_registro .= " idliberacao =\"" . $this->trata_dados($this->idliberacao) . "\"";
   }
   //----- hora
   function NM_export_hora()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->hora))
         {
             $this->hora = mb_convert_encoding($this->hora, "UTF-8");
         }
         $this->xml_registro .= " hora =\"" . $this->trata_dados($this->hora) . "\"";
   }
   //----- dia
   ...
   function NM_export_motivo()
   {
         ...
         {
             $this->motivo = mb_convert_encoding($this->motivo, "UTF-8");
         }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_liberacao']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - liberacao :: XML</TITLE>
...
<FORM name="F0" method=post action="grid_liberacao.php" style="display: none"> 
