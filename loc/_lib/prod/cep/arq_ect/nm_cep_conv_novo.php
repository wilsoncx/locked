...
//
    ...
    $root = "F:/wwwroot/desenv/scriptcase6/prod/cep/arquivos";
    $base = "F:/wwwroot/desenv/scriptcase6/prod/cep/arq_ect/basemdb.mdb";

    ADOLoadCode('ado_access');
    $Db = &ADONewConnection('ado_access');
    $myDSN = "PROVIDER=Microsoft.Jet.OLEDB.4.0;DATA SOURCE=$base;" ;
    $Db->Connect($myDSN, "", "", "");
