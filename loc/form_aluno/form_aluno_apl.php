...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['cel_resp']))
          {
              $this->cel_resp = $this->NM_ajax_info['param']['cel_resp'];
          }
          ...
          {
              $this->data_nasc = $this->NM_ajax_info['param']['data_nasc'];
          }
          if (isset($this->NM_ajax_info['param']['email_resp']))
          {
              $this->email_resp = $this->NM_ajax_info['param']['email_resp'];
          }
          ...
          {
              $this->idaluno = $this->NM_ajax_info['param']['idaluno'];
          }
          if (isset($this->NM_ajax_info['param']['idcarteira']))
          {
              $this->idcarteira = $this->NM_ajax_info['param']['idcarteira'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['nome_resp']))
          {
              $this->nome_resp = $this->NM_ajax_info['param']['nome_resp'];
          }
      ...
      {
          $aDtParts = explode(' ', $this->data_nasc);
          $this->data_nasc      = $aDtParts[0];
          $this->data_nasc_hora = $aDtParts[1];
      }
      ...
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_aluno.php"; 
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] = "inicio";
...
//
      ...
      if (isset($this->idaluno)) { $this->nm_limpa_alfa($this->idaluno); }
      if (isset($this->idcarteira)) { $this->nm_limpa_alfa($this->idcarteira); }
      ...
      if (isset($this->nome_resp)) { $this->nm_limpa_alfa($this->nome_resp); }
      if (isset($this->cel_resp)) { $this->nm_limpa_alfa($this->cel_resp); }
      if (isset($this->email_resp)) { $this->nm_limpa_alfa($this->email_resp); }
   ...
   function loadFieldConfig()
   {
      ...
      //-- idaluno
      $this->field_config['idaluno']               = array();
      $this->field_config['idaluno']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idaluno']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idaluno']['symbol_dec'] = '';
      $this->field_config['idaluno']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idaluno']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- data_nasc
      $this->field_config['data_nasc']                 = array();
      $this->field_config['data_nasc']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['data_nasc']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['data_nasc']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['data_nasc']['date_display'] = "ddmmaaaa";
      $this->new_date_format('DH', 'data_nasc');
   }
...
//
      ...
      {
          if ('validate_idaluno' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idaluno');
          }
          if ('validate_foto' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'foto');
          }
          if ('validate_idcarteira' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idcarteira');
          }
          ...
          if ('validate_data_nasc' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'data_nasc');
          }
          ...
          if ('validate_nome_resp' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nome_resp');
          }
          if ('validate_cel_resp' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cel_resp');
          }
          if ('validate_email_resp' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'email_resp');
          }
...
//---------------------------------------------------------
     $this->sc_force_zero = array();
      if ('' == $filtro || 'idaluno' == $filtro)
        $this->ValidateField_idaluno($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'foto' == $filtro)
        $this->ValidateField_foto($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'idcarteira' == $filtro)
        $this->ValidateField_idcarteira($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'data_nasc' == $filtro)
        $this->ValidateField_data_nasc($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'nome_resp' == $filtro)
        $this->ValidateField_nome_resp($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'cel_resp' == $filtro)
        $this->ValidateField_cel_resp($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'email_resp' == $filtro)
        $this->ValidateField_email_resp($Campos_Crit, $Campos_Falta, $Campos_Erros);
      $this->upload_img_doc($Campos_Crit, $Campos_Falta, $Campos_Erros) ; 
//-- converter datas   
      $this->nm_converte_datas();
//---
    ...
    function ValidateField_idaluno(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->idaluno, $this->field_config['idaluno']['symbol_grp']) ; 
      if ($this->nmgp_opcao == "incluir")
      { 
          if ($this->idaluno != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->idaluno) > $iTestSize)  
              { 
                  $Campos_Crit .= "Codigo: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idaluno']))
                  {
                      $Campos_Erros['idaluno'] = array();
                  }
                  $Campos_Erros['idaluno'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idaluno']) || !is_array($this->NM_ajax_info['errList']['idaluno']))
                  {
                      $this->NM_ajax_info['errList']['idaluno'] = array();
                  }
                  $this->NM_ajax_info['errList']['idaluno'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idaluno, 11, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Codigo; " ; 
                  if (!isset($Campos_Erros['idaluno']))
                  {
                  ...
                  $Campos_Erros['idaluno'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idaluno']) || !is_array($this->NM_ajax_info['errList']['idaluno']))
                  {
                      $this->NM_ajax_info['errList']['idaluno'] = array();
                  }
                  $this->NM_ajax_info['errList']['idaluno'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_idaluno
    ...
    function ValidateField_idcarteira(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->idcarteira) > 45) 
          { 
              $Campos_Crit .= "Numero da Carteira " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['idcarteira']))
              {
                  $Campos_Erros['idcarteira'] = array();
              }
              $Campos_Erros['idcarteira'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['idcarteira']) || !is_array($this->NM_ajax_info['errList']['idcarteira']))
              {
                  $this->NM_ajax_info['errList']['idcarteira'] = array();
              }
              $this->NM_ajax_info['errList']['idcarteira'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_idcarteira
    ...
    function ValidateField_data_nasc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      nm_limpa_data($this->data_nasc, $this->field_config['data_nasc']['date_sep']) ; 
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['data_nasc']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['data_nasc']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['data_nasc']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['data_nasc']['date_sep']) ; 
          if (trim($this->data_nasc) != "")  
          { 
              if ($teste_validade->Data($this->data_nasc, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $Campos_Crit .= "Data Nascimento; " ; 
                  if (!isset($Campos_Erros['data_nasc']))
                  {
                      $Campos_Erros['data_nasc'] = array();
                  }
                  $Campos_Erros['data_nasc'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['data_nasc']) || !is_array($this->NM_ajax_info['errList']['data_nasc']))
                  {
                      $this->NM_ajax_info['errList']['data_nasc'] = array();
                  }
                  $this->NM_ajax_info['errList']['data_nasc'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
          $this->field_config['data_nasc']['date_format'] = $guarda_datahora; 
       } 
      nm_limpa_hora($this->data_nasc_hora, $this->field_config['data_nasc_hora']['time_sep']) ; 
      if ($this->nmgp_opcao != "excluir") 
      {
          $Format_Hora = $this->field_config['data_nasc_hora']['date_format']; 
          nm_limpa_hora($Format_Hora, $this->field_config['data_nasc_hora']['time_sep']) ; 
          if (trim($this->data_nasc_hora) != "")  
          { 
              if ($teste_validade->Hora($this->data_nasc_hora, $Format_Hora) == false)  
              { 
                  $Campos_Crit .= "Data Nascimento; " ; 
                  if (!isset($Campos_Erros['data_nasc_hora']))
                  {
                      $Campos_Erros['data_nasc_hora'] = array();
                  }
                  $Campos_Erros['data_nasc_hora'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['data_nasc']) || !is_array($this->NM_ajax_info['errList']['data_nasc']))
                  {
                      $this->NM_ajax_info['errList']['data_nasc'] = array();
                  }
      ...
      if (isset($Campos_Erros['data_nasc']) && isset($Campos_Erros['data_nasc_hora']))
      {
          $this->removeDuplicateDttmError($Campos_Erros['data_nasc'], $Campos_Erros['data_nasc_hora']);
          if (empty($Campos_Erros['data_nasc_hora']))
          {
              unset($Campos_Erros['data_nasc_hora']);
          }
          if (isset($this->NM_ajax_info['errList']['data_nasc']))
          {
              $this->NM_ajax_info['errList']['data_nasc'] = array_unique($this->NM_ajax_info['errList']['data_nasc']);
          }
      }
    } // ValidateField_data_nasc_hora

    function ValidateField_turma(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->turma) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_turma']) && !in_array($this->turma, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_turma']))
               {
    ...
    function ValidateField_endereco(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->endereco) > 45) 
          { 
              $Campos_Crit .= "Endereco " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['endereco']))
              {
                  $Campos_Erros['endereco'] = array();
              }
              $Campos_Erros['endereco'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['endereco'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_cidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->cidade) > 45) 
          { 
              $Campos_Crit .= "Cidade " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['cidade']))
              {
                  $Campos_Erros['cidade'] = array();
              }
              $Campos_Erros['cidade'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['cidade'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_uf(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->uf) > 45) 
          { 
              $Campos_Crit .= "Uf " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['uf']))
              {
                  $Campos_Erros['uf'] = array();
              }
              $Campos_Erros['uf'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['uf']) || !is_array($this->NM_ajax_info['errList']['uf']))
              {
                  $this->NM_ajax_info['errList']['uf'] = array();
              }
              $this->NM_ajax_info['errList']['uf'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_uf

    function ValidateField_nome_resp(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->nome_resp) > 70) 
          { 
              $Campos_Crit .= "Nome Resp " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['nome_resp']))
              {
                  $Campos_Erros['nome_resp'] = array();
              }
              $Campos_Erros['nome_resp'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['nome_resp']) || !is_array($this->NM_ajax_info['errList']['nome_resp']))
              {
                  $this->NM_ajax_info['errList']['nome_resp'] = array();
              }
              $this->NM_ajax_info['errList']['nome_resp'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_nome_resp

    function ValidateField_cel_resp(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->cel_resp) > 45) 
          { 
              $Campos_Crit .= "Cel Resp " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['cel_resp']))
              {
                  $Campos_Erros['cel_resp'] = array();
              }
              $Campos_Erros['cel_resp'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['cel_resp']) || !is_array($this->NM_ajax_info['errList']['cel_resp']))
              {
                  $this->NM_ajax_info['errList']['cel_resp'] = array();
              }
              $this->NM_ajax_info['errList']['cel_resp'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_cel_resp

    function ValidateField_email_resp(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->email_resp) > 45) 
          { 
              $Campos_Crit .= "Email Resp " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['email_resp']))
              {
                  $Campos_Erros['email_resp'] = array();
              }
              $Campos_Erros['email_resp'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['email_resp']) || !is_array($this->NM_ajax_info['errList']['email_resp']))
              {
                  $this->NM_ajax_info['errList']['email_resp'] = array();
              }
              $this->NM_ajax_info['errList']['email_resp'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_email_resp
//
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros) 
   {
     global $nm_browser;
      ...
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['dados_form']['foto']) && $this->foto_limpa != "S")
          {
              $this->foto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['dados_form']['foto'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['idaluno'] = $this->idaluno;
    if (empty($this->foto))
    {
    ...
    $this->nmgp_dados_form['idcarteira'] = $this->idcarteira;
    $this->nmgp_dados_form['nome'] = $this->nome;
    $this->nmgp_dados_form['sexo'] = $this->sexo;
    $this->nmgp_dados_form['data_nasc'] = $this->data_nasc;
    ...
    $this->nmgp_dados_form['nome_resp'] = $this->nome_resp;
    $this->nmgp_dados_form['cel_resp'] = $this->cel_resp;
    $this->nmgp_dados_form['email_resp'] = $this->email_resp;
   ...
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->idaluno, $this->field_config['idaluno']['symbol_grp']) ; 
      nm_limpa_data($this->data_nasc, $this->field_config['data_nasc']['date_sep']) ; 
      nm_limpa_hora($this->data_nasc_hora, $this->field_config['data_nasc']['time_sep']) ; 
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if (!empty($this->idaluno) || (!empty($format_fields) && isset($format_fields['idaluno'])))
      {
          nmgp_Form_Num_Val($this->idaluno, $this->field_config['idaluno']['symbol_grp'], $this->field_config['idaluno']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['idaluno']['symbol_fmt']) ; 
      }
      if ((!empty($this->data_nasc) && 'null' != $this->data_nasc) || (!empty($format_fields) && isset($format_fields['data_nasc'])))
      {
          $nm_separa_data = strpos($this->field_config['data_nasc']['date_format'], ";") ;
          $guarda_format_hora = $this->field_config['data_nasc']['date_format'];
          $this->field_config['data_nasc']['date_format'] = substr($this->field_config['data_nasc']['date_format'], 0, $nm_separa_data) ;
          $separador = strpos($this->data_nasc, " ") ; 
          $this->data_nasc_hora = substr($this->data_nasc, $separador + 1) ; 
          $this->data_nasc = substr($this->data_nasc, 0, $separador) ; 
          nm_volta_data($this->data_nasc, $this->field_config['data_nasc']['date_format']) ; 
          nmgp_Form_Datas($this->data_nasc, $this->field_config['data_nasc']['date_format'], $this->field_config['data_nasc']['date_sep']) ;  
          $this->field_config['data_nasc']['date_format'] = substr($guarda_format_hora, $nm_separa_data + 1) ;
          nm_volta_hora($this->data_nasc_hora, $this->field_config['data_nasc']['date_format']) ; 
          nmgp_Form_Hora($this->data_nasc_hora, $this->field_config['data_nasc']['date_format'], $this->field_config['data_nasc']['time_sep']) ;  
          $this->field_config['data_nasc']['date_format'] = $guarda_format_hora ;
      }
      elseif ('null' == $this->data_nasc || '' == $this->data_nasc)
      {
          $this->data_nasc_hora = '';
          $this->data_nasc = '';
      }
...
//-- 
   function nm_converte_datas($use_null = true)
   {
      ...
      { 
          $nm_separa_data = strpos($this->field_config['data_nasc']['date_format'], ";") ;
          $this->field_config['data_nasc']['date_format'] = substr($this->field_config['data_nasc']['date_format'], 0, $nm_separa_data) ;
          nm_conv_data($this->data_nasc, $this->field_config['data_nasc']['date_format']) ; 
          $this->field_config['data_nasc']['date_format'] = substr($guarda_format_hora, $nm_separa_data + 1) ;
          nm_conv_hora($this->data_nasc_hora, $this->field_config['data_nasc']['date_format']) ; 
          if ($this->data_nasc_hora == "" )  
          { 
              $this->data_nasc_hora = "00:00:00:000" ; 
          }
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->data_nasc_hora = substr($this->data_nasc_hora, 0, -4);
          }
          if ($this->data_nasc != "")  
          { 
   ...
   {
          $this->ajax_return_values_idaluno();
          $this->ajax_return_values_foto();
          $this->ajax_return_values_idcarteira();
          $this->ajax_return_values_nome();
          $this->ajax_return_values_sexo();
          $this->ajax_return_values_data_nasc();
          ...
          $this->ajax_return_values_nome_resp();
          $this->ajax_return_values_cel_resp();
          $this->ajax_return_values_email_resp();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idaluno']['keyVal'] = form_aluno_pack_protect_string($this->nmgp_dados_form['idaluno']);
          }
   } // ajax_return_values

          //----- idaluno
   function ajax_return_values_idaluno($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idaluno", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idaluno);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['idaluno'] = array(
                       'row'    => '',
               'type'    => 'label',
   ...
   { 
       $out_foto = $this->Ini->path_imag_temp . "/sc_foto_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".gif" ;  
       $out1_foto = $out_foto; 
       ...
       $_SESSION['scriptcase']['sc_num_img']++ ; 
          ...
          //----- idcarteira
   function ajax_return_values_idcarteira($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idcarteira", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idcarteira);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['idcarteira'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
$aLookup[] = array(form_aluno_pack_protect_string('M') => form_aluno_pack_protect_string("Masculino"));
$aLookup[] = array(form_aluno_pack_protect_string('F') => form_aluno_pack_protect_string("Feminino"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_sexo'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_sexo'][] = 'F';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sexo\"";
          ...
          //----- data_nasc
   function ajax_return_values_data_nasc($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("data_nasc", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->data_nasc);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['data_nasc'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->data_nasc . ' ' . $this->data_nasc_hora),
              );
          }
   }
...
$aLookup[] = array(form_aluno_pack_protect_string('null') => form_aluno_pack_protect_string('Escolha a Turma'));
...
ORDER BY nome";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_aluno_pack_protect_string($rs->fields[0]) => form_aluno_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   function ajax_return_values_uf($bForce = false)
   {
          ...
          //----- nome_resp
   function ajax_return_values_nome_resp($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nome_resp", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nome_resp);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nome_resp'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- cel_resp
   function ajax_return_values_cel_resp($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cel_resp", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cel_resp);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cel_resp'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- email_resp
   function ajax_return_values_email_resp($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("email_resp", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->email_resp);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['email_resp'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
{
    $original_idaluno = $this->idaluno;
}
             /* liberacao_X_aluno */
      $sc_cmd_dependency = "SELECT COUNT(*) FROM liberacao_X_aluno WHERE aluno = " . $this->idaluno ;
...
;
            ...
            /* turma_ano */
      $sc_cmd_dependency = "SELECT COUNT(*) FROM turma_ano WHERE idaluno = " . $this->idaluno ;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_idaluno != $this->idaluno || (isset($bFlagRead_idaluno) && $bFlagRead_idaluno)))
    {
        $this->ajax_return_values_idaluno(true);
    }
}
$_SESSION['scriptcase']['form_aluno']['contr_erro'] = 'off'; 
    }
      ...
      $NM_val_form['idaluno'] = $this->idaluno;
      $NM_val_form['foto'] = $this->foto;
      $NM_val_form['idcarteira'] = $this->idcarteira;
      $NM_val_form['nome'] = $this->nome;
      $NM_val_form['sexo'] = $this->sexo;
      $NM_val_form['data_nasc'] = $this->data_nasc;
      ...
      $NM_val_form['nome_resp'] = $this->nome_resp;
      $NM_val_form['cel_resp'] = $this->cel_resp;
      $NM_val_form['email_resp'] = $this->email_resp;
      if ($this->idaluno == "")  
      { 
          $this->idaluno = 0;
      } 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          { 
              $this->foto =  addslashes($this->foto);
          } 
          $this->idcarteira = substr($this->Db->qstr($this->idcarteira), 1, -1); 
          $this->nome = substr($this->Db->qstr($this->nome), 1, -1); 
          $this->sexo = substr($this->Db->qstr($this->sexo), 1, -1); 
          if ($this->data_nasc == "")  
          { 
              $this->data_nasc = "null"; 
              $NM_val_null[] = "data_nasc";
          } 
          ...
          $this->nome_resp = substr($this->Db->qstr($this->nome_resp), 1, -1); 
          $this->cel_resp = substr($this->Db->qstr($this->cel_resp), 1, -1); 
          $this->email_resp = substr($this->Db->qstr($this->email_resp), 1, -1); 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) from " . $this->Ini->nm_tabela . " where idaluno = $this->idaluno ";
          $rs1 = $this->Db->Execute("select count(*) from " . $this->Ini->nm_tabela . " where idaluno = $this->idaluno "); 
          if ($rs1 === false)  
          { 
              $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              if ($this->NM_ajax_flag)
          ...
          { 
              $rs1->Close(); 
              $comando_oracle = "";  
              $comando = "UPDATE " . $this->Ini->nm_tabela . " SET idcarteira = '$this->idcarteira', nome = '$this->nome', sexo = '$this->sexo', data_nasc = '$this->data_nasc', endereco = '$this->endereco', bairro = '$this->bairro', cidade = '$this->cidade', uf = '$this->uf', nome_resp = '$this->nome_resp', cel_resp = '$this->cel_resp', email_resp = '$this->email_resp', turma = $this->turma";  
              $temp_cmd_sql = "";
              ...
              $comando .= " WHERE idaluno = $this->idaluno ";  
              ...
              { 
                  ...
                  { 
                      $_SESSION['scriptcase']['sc_sql_ult_comando'] = "UpdateBlob($this->Ini->nm_tabela, \"foto\", \"\",  \"idaluno = $this->idaluno\")"; 
                      $rs = $this->Db->UpdateBlob($this->Ini->nm_tabela, "foto", "",  "idaluno = $this->idaluno"); 
                  } 
                  else 
                  { 
                      if ($this->foto != "none" && $this->foto != "") 
                      { 
                          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "UpdateBlob($this->Ini->nm_tabela, \"foto\", $this->foto,  \"idaluno = $this->idaluno\")"; 
                          $rs = $this->Db->UpdateBlob($this->Ini->nm_tabela, "foto", $this->foto,  "idaluno = $this->idaluno"); 
                      } 
                  } 
                  if ($rs === false) 
                  { 
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['idaluno'])) { $this->idaluno = $NM_val_form['idaluno']; }
              elseif (isset($this->idaluno)) { $this->nm_limpa_alfa($this->idaluno); }
              if     (isset($NM_val_form) && isset($NM_val_form['idcarteira'])) { $this->idcarteira = $NM_val_form['idcarteira']; }
              elseif (isset($this->idcarteira)) { $this->nm_limpa_alfa($this->idcarteira); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['nome_resp'])) { $this->nome_resp = $NM_val_form['nome_resp']; }
              elseif (isset($this->nome_resp)) { $this->nm_limpa_alfa($this->nome_resp); }
              if     (isset($NM_val_form) && isset($NM_val_form['cel_resp'])) { $this->cel_resp = $NM_val_form['cel_resp']; }
              elseif (isset($this->cel_resp)) { $this->nm_limpa_alfa($this->cel_resp); }
              if     (isset($NM_val_form) && isset($NM_val_form['email_resp'])) { $this->email_resp = $NM_val_form['email_resp']; }
              elseif (isset($this->email_resp)) { $this->nm_limpa_alfa($this->email_resp); }
              ...
              $this->nmgp_refresh_fields = array('idaluno', 'idcarteira', 'nome', 'sexo', 'data_nasc', 'turma', 'endereco', 'bairro', 'cidade', 'uf', 'nome_resp', 'cel_resp', 'email_resp');
              $this->ajax_return_values();
      ...
      { 
          ...
          if ($bInsertOk)
          { 
              $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "foto, idcarteira, nome, sexo, data_nasc, endereco, bairro, cidade, uf, nome_resp, cel_resp, email_resp, turma) VALUES (" . $NM_seq_auto . "'$this->foto', '$this->idcarteira', '$this->nome', '$this->sexo', '$this->data_nasc', '$this->endereco', '$this->bairro', '$this->cidade', '$this->uf', '$this->nome_resp', '$this->cel_resp', '$this->email_resp', $this->turma)"; 
              $comando = str_replace("'null'", "null", $comando) ; 
              $comando = str_replace("#null#", "null", $comando) ; 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $comando; 
              $rs = $this->Db->Execute($comando); 
      ...
      if ($this->nmgp_opcao == "excluir") 
      { 
          $this->idaluno = substr($this->Db->qstr($this->idaluno), 1, -1); 
          ...
          { 
              $rs1->Close(); 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where idaluno = $this->idaluno "; 
              $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where idaluno = $this->idaluno "); 
              if ($rs === false) 
              { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['parms'] = "idaluno?#?$this->idaluno?@?"; 
      }
...
//------------ 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['iframe_evento'] = $this->sc_evento; 
      } 
      if (!isset($this->nmgp_opcao) || empty($this->nmgp_opcao)) 
      { 
          if (empty($this->idaluno)) 
          { 
              $this->nmgp_opcao = "inicio"; 
          } 
          else 
      ...
      if ($this->nmgp_opcao != "nada" && (trim($this->idaluno) === "")) 
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idaluno))
          {
              $Key_Where = "idaluno < $this->idaluno "; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_aluno = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] > $qt_geral_reg_form_aluno)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] = $qt_geral_reg_form_aluno; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_aluno) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'] + 1; 
...
//---------- 
      ...
      { 
          ...
          { 
              ...
              $this->nmgp_dados_select['data_nasc'] = $this->data_nasc;
              $this->endereco = $rs->fields[6] ; 
              $this->nmgp_dados_select['endereco'] = $this->endereco;
              $this->bairro = $rs->fields[7] ; 
              $this->nmgp_dados_select['bairro'] = $this->bairro;
              $this->cidade = $rs->fields[8] ; 
              $this->nmgp_dados_select['cidade'] = $this->cidade;
              $this->uf = $rs->fields[9] ; 
              $this->nmgp_dados_select['uf'] = $this->uf;
              $this->nome_resp = $rs->fields[10] ; 
              $this->nmgp_dados_select['nome_resp'] = $this->nome_resp;
              $this->cel_resp = $rs->fields[11] ; 
              $this->nmgp_dados_select['cel_resp'] = $this->cel_resp;
              $this->email_resp = $rs->fields[12] ; 
              $this->nmgp_dados_select['email_resp'] = $this->email_resp;
              $this->turma = $rs->fields[13] ; 
              $this->nmgp_dados_select['turma'] = $this->turma;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->idaluno = (string)$this->idaluno; 
              $this->turma = (string)$this->turma; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['parms'] = "idaluno?#?$this->idaluno?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['sub_dir'][0]  = "";
          } 
...
//-- 
   ...
   {  
     ...
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idaluno) from " . $this->Ini->nm_tabela . " where idaluno < $this->idaluno" . $str_where_filter; 
     $rs = $this->Db->Execute("select max(idaluno) from " . $this->Ini->nm_tabela . " where idaluno < $this->idaluno" . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
     ...
     { 
         $this->idaluno = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $str_where_filter = ('' != $str_where_param) ? ' and ' . $str_where_param : '';
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idaluno) from " . $this->Ini->nm_tabela . " where idaluno > $this->idaluno" . $str_where_filter; 
     $rs = $this->Db->Execute("select min(idaluno) from " . $this->Ini->nm_tabela . " where idaluno > $this->idaluno" . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
//-- 
   ...
   {   
     ...
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idaluno) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
     $rs = $this->Db->Execute("select min(idaluno) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
//-- 
   ...
   { 
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $str_where_filter = ('' != $str_where_param) ? ' where ' . $str_where_param : '';
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idaluno) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idaluno) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['reg_start'] + 1;
...
//-- 
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "idcarteira", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "nome_resp", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "cel_resp", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "email_resp", $arg_search, $data_search);
      }
   ...
   {
       $result = array();
       $nm_comando = "SELECT nome, idturma FROM turma WHERE (nome LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
