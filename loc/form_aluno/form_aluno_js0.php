<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="idaluno" value="<?php echo NM_encode_input($this->nmgp_dados_form['idaluno']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'idcarteira', 'Numero da Carteira', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'nome', 'Nome', 'naomask', 'lista', 'cxab', 80, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'data_nasc', 'Data Nascimento', 'naomask', 'data', '<?php echo $this->field_config['data_nasc']['date_format']; ?>'<?php echo ", '', ''"; ?>, '<?php echo $this->field_config['data_nasc']['date_sep']; ?>');
 NM_tab_crit[4] = new NM_critica('F1', 'endereco', 'Endereco', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[5] = new NM_critica('F1', 'bairro', 'Bairro', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[6] = new NM_critica('F1', 'cidade', 'Cidade', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[7] = new NM_critica('F1', 'uf', 'Uf', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[8] = new NM_critica('F1', 'nome_resp', 'Nome Resp', 'naomask', 'lista', 'cxab', 70, 'TUDO');
 NM_tab_crit[9] = new NM_critica('F1', 'cel_resp', 'Cel Resp', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[10] = new NM_critica('F1', 'email_resp', 'Email Resp', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[11] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(11);
 NM_tab_crit_1[1] = new NM_critica('F1', 'idcarteira', 'Numero da Carteira', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'nome', 'Nome', 'naomask', 'lista', 'cxab', 80, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'data_nasc', 'Data Nascimento', 'naomask', 'data', '<?php echo $this->field_config['data_nasc']['date_format']; ?>'<?php echo ", '', ''"; ?>, '<?php echo $this->field_config['data_nasc']['date_sep']; ?>');
 NM_tab_crit_1[4] = new NM_critica('F1', 'endereco', 'Endereco', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[5] = new NM_critica('F1', 'bairro', 'Bairro', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[6] = new NM_critica('F1', 'cidade', 'Cidade', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[7] = new NM_critica('F1', 'uf', 'Uf', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[8] = new NM_critica('F1', 'nome_resp', 'Nome Resp', 'naomask', 'lista', 'cxab', 70, 'TUDO');
 NM_tab_crit_1[9] = new NM_critica('F1', 'cel_resp', 'Cel Resp', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[10] = new NM_critica('F1', 'email_resp', 'Email Resp', 'naomask', 'lista', 'cxab', 45, 'TUDO');
