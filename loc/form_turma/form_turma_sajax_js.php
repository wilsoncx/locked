  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_turma" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idturma
  function do_ajax_form_turma_validate_idturma()
  {
    var nomeCampo_idturma = "idturma";
    var var_idturma = scAjaxGetFieldHidden(nomeCampo_idturma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_turma_validate_idturma(var_idturma, var_script_case_init, do_ajax_form_turma_validate_idturma_cb);
  } // do_ajax_form_turma_validate_idturma

  function do_ajax_form_turma_validate_idturma_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_turma_validate_idturma_cb

  // ---------- Validate nome
  function do_ajax_form_turma_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_turma_validate_nome(var_nome, var_script_case_init, do_ajax_form_turma_validate_nome_cb);
  } // do_ajax_form_turma_validate_nome

  function do_ajax_form_turma_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_turma_validate_nome_cb

  // ---------- Validate turno
  function do_ajax_form_turma_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldSelect(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_turma_validate_turno(var_turno, var_script_case_init, do_ajax_form_turma_validate_turno_cb);
  } // do_ajax_form_turma_validate_turno

  function do_ajax_form_turma_validate_turno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "turno";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_turma_validate_turno_cb

  // ---------- Validate alunos
  function do_ajax_form_turma_validate_alunos()
  {
    var nomeCampo_alunos = "alunos";
    var var_alunos = scAjaxGetFieldText(nomeCampo_alunos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_turma_validate_alunos(var_alunos, var_script_case_init, do_ajax_form_turma_validate_alunos_cb);
  } // do_ajax_form_turma_validate_alunos

  function do_ajax_form_turma_validate_alunos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "alunos";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_turma_validate_alunos_cb

  // ---------- Validate horarios
  function do_ajax_form_turma_validate_horarios()
  {
    var nomeCampo_horarios = "horarios";
    nm_pack(nomeCampo_horarios + '_dest', nomeCampo_horarios);
    var var_horarios = scAjaxGetFieldText(nomeCampo_horarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_turma_validate_horarios(var_horarios, var_script_case_init, do_ajax_form_turma_validate_horarios_cb);
  } // do_ajax_form_turma_validate_horarios

  function do_ajax_form_turma_validate_horarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "horarios";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_turma_validate_horarios_cb
  // ---------- Form
  function do_ajax_form_turma_submit_form()
  {
    scAjaxHideMessage();
    var var_idturma = scAjaxGetFieldHidden("idturma");
    var var_nome = scAjaxGetFieldText("nome");
    var var_turno = scAjaxGetFieldSelect("turno");
    nm_pack("horarios_dest", "horarios");
    var var_horarios = scAjaxGetFieldText("horarios", "@?@");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_turma_submit_form(var_idturma, var_nome, var_turno, var_horarios, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_turma_submit_form_cb);
  } // do_ajax_form_turma_submit_form

  function do_ajax_form_turma_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_turma_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_aluno_view_list"] = "off";

  function do_ajax_form_turma_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("alunos");
    scAjaxHideErrorDisplay("horarios");
    var var_idturma = document.F2.idturma.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_aluno_view_list"] = "on";
    x_ajax_form_turma_navigate_form(var_idturma, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_turma_navigate_form_cb);
  } // do_ajax_form_turma_navigate_form

  function do_ajax_form_turma_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idturma.value = scAjaxGetKeyValue("idturma");
    scAjaxSetSummary();
    scAjaxShowDebug();
    ...
    document.getElementById('nmsc_iframe_liga_form_aluno_view_list').contentWindow.nm_move('apl_detalhe', true);
    document.getElementById('nmsc_iframe_liga_form_aluno_view_list').style.height = "1";
    document.getElementById('nmsc_iframe_liga_form_aluno_view_list').style.display = "none";
    scAjaxSetBtnVars();
...
{
?>
    do_ajax_form_turma_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_turma_navigate_form_cb
  ...
  {
    if ("off" == scStatusDetail["form_aluno_view_list"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idturma";
  ajax_field_list[1] = "nome";
  ajax_field_list[2] = "turno";
  ajax_field_list[3] = "alunos";
  ajax_field_list[4] = "horarios";
  ...
  var ajax_error_list = {
    "idturma": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "horarios": {"label": "Horarios", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idturma"][1] = "idturma";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["turno"][1] = "turno";
  ajax_field_mult["alunos"][1] = "alunos";
  ajax_field_mult["horarios"][1] = "horarios";

  var ajax_field_id = {
    "idturma": new Array("hidden_field_label_idturma", "hidden_field_data_idturma"),
    ...
    "horarios": new Array("hidden_field_label_horarios", "hidden_field_data_horarios")
  };
