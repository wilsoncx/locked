...
<td style="padding: 0px">
 <TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" ID="id_tabs_0_2">
  ...
  <TR>
   ...
   <TD ID="id_tabs_0_2_5" class="scTabInactive scTabInactiveBg" nowrap><A HREF="javascript: sc_control_tabs_0(2)" class="scTabInactiveFont" ID="id_tabs_0_2_font">Horário</A></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['idturma'] = "Código";
    }
?>
<?php
