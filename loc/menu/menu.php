...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_turma") . "/grid_turma_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_turma']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_turma'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_horario") . "/grid_horario_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_horario']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_horario'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_liberacao") . "/grid_liberacao_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_liberacao']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_liberacao'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Fair_Blue_hor.css<?php if (@is_file($this->path_css . '_menuTheme/' . scriptcase_Fair_Blue . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . scriptcase_Fair_Blue . '_' . hor . '.css'); } ?>" />
</head>
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_aluno']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_aluno']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[0] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_aluno&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_1",
        'icon'     => "",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_turma']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_turma']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[1] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_turma&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_2",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_horario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_horario']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[2] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_horario&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_3",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_liberacao']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_liberacao']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[3] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_liberacao&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_4",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
