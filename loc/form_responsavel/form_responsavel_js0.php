<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="idresponsavel" value="<?php echo NM_encode_input($this->nmgp_dados_form['idresponsavel']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsavel']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'nome', 'Nome', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'celular', 'Celular', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'email', 'Email', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'cpf', 'Cpf', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit[5] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(5);
 NM_tab_crit_1[1] = new NM_critica('F1', 'nome', 'Nome', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'celular', 'Celular', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'email', 'Email', 'naomask', 'lista', 'cxab', 45, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'cpf', 'Cpf', 'naomask', 'lista', 'cxab', 15, 'TUDO');
