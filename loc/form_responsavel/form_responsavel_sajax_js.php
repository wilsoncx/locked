  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_responsavel" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idresponsavel
  function do_ajax_form_responsavel_validate_idresponsavel()
  {
    var nomeCampo_idresponsavel = "idresponsavel";
    var var_idresponsavel = scAjaxGetFieldHidden(nomeCampo_idresponsavel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_responsavel_validate_idresponsavel(var_idresponsavel, var_script_case_init, do_ajax_form_responsavel_validate_idresponsavel_cb);
  } // do_ajax_form_responsavel_validate_idresponsavel

  function do_ajax_form_responsavel_validate_idresponsavel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idresponsavel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_responsavel_validate_idresponsavel_cb

  // ---------- Validate nome
  function do_ajax_form_responsavel_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_responsavel_validate_nome(var_nome, var_script_case_init, do_ajax_form_responsavel_validate_nome_cb);
  } // do_ajax_form_responsavel_validate_nome

  function do_ajax_form_responsavel_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_responsavel_validate_nome_cb

  // ---------- Validate celular
  function do_ajax_form_responsavel_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_responsavel_validate_celular(var_celular, var_script_case_init, do_ajax_form_responsavel_validate_celular_cb);
  } // do_ajax_form_responsavel_validate_celular

  function do_ajax_form_responsavel_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "celular";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_responsavel_validate_celular_cb

  // ---------- Validate email
  function do_ajax_form_responsavel_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_responsavel_validate_email(var_email, var_script_case_init, do_ajax_form_responsavel_validate_email_cb);
  } // do_ajax_form_responsavel_validate_email

  function do_ajax_form_responsavel_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_responsavel_validate_email_cb

  // ---------- Validate cpf
  function do_ajax_form_responsavel_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_responsavel_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_responsavel_validate_cpf_cb);
  } // do_ajax_form_responsavel_validate_cpf

  function do_ajax_form_responsavel_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_responsavel_validate_cpf_cb
  // ---------- Form
  function do_ajax_form_responsavel_submit_form()
  {
    scAjaxHideMessage();
    var var_idresponsavel = scAjaxGetFieldHidden("idresponsavel");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_responsavel_submit_form(var_idresponsavel, var_nome, var_celular, var_email, var_cpf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_responsavel_submit_form_cb);
  } // do_ajax_form_responsavel_submit_form

  function do_ajax_form_responsavel_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idresponsavel");
  ...
  } // do_ajax_form_responsavel_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_responsavel_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("email");
    scAjaxHideErrorDisplay("cpf");
    var var_idresponsavel = document.F2.idresponsavel.value;
    ...
    scAjaxProcOn();
    x_ajax_form_responsavel_navigate_form(var_idresponsavel, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_responsavel_navigate_form_cb);
  } // do_ajax_form_responsavel_navigate_form

  function do_ajax_form_responsavel_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idresponsavel.value = scAjaxGetKeyValue("idresponsavel");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_responsavel_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_responsavel_navigate_form_cb
  ...
  ajax_field_list[0] = "idresponsavel";
  ajax_field_list[1] = "nome";
  ajax_field_list[2] = "celular";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "cpf";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idresponsavel": {"label": "Idresponsavel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idresponsavel": new Array(),
    "nome": new Array(),
    "celular": new Array(),
    "email": new Array(),
    "cpf": new Array()
  };
  ajax_field_mult["idresponsavel"][1] = "idresponsavel";
  ...
  var ajax_field_id = {
    "idresponsavel": new Array("hidden_field_label_idresponsavel", "hidden_field_data_idresponsavel"),
