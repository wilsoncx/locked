...
$old_error_handler = set_error_handler("form_responsavel_scriptcase_error_handler");

function form_responsavel_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_responsavel']['contr_erro']) && $_SESSION['scriptcase']['form_responsavel']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_responsavel->contr_form_responsavel->Apl_com_erro = true;
            if ($inicial_form_responsavel->contr_form_responsavel->NM_ajax_flag)
            {
                $inicial_form_responsavel->contr_form_responsavel->NM_ajax_info['errList']['geral_form_responsavel'][] = $msg;
                return;
            }
            form_responsavel_scriptcase_error_display($msg, $err_no);
        }
...
function form_responsavel_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_responsavel'])  && '' != $_SESSION['scriptcase']['error_icon']['form_responsavel'])  ? $_SESSION['scriptcase']['error_icon']['form_responsavel']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_responsavel']) && '' != $_SESSION['scriptcase']['error_span_title']['form_responsavel']) ? $_SESSION['scriptcase']['error_span_title']['form_responsavel'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_responsavel']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_responsavel']) ? $_SESSION['scriptcase']['error_icon_title']['form_responsavel'] : '';
?>
