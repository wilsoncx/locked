...
<?php
include_once("form_aluno_view_list_inline_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aluno_view_list_inline_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['recarga'];
}
?>
...
<?php
 include_once("form_aluno_view_list_inline_js0.php");
?>
...
<input type=hidden name="idaluno_" value="<?php  echo NM_encode_input($this->idaluno_) ?>">
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_aluno_view_list_inline'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aluno_view_list_inline'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
   ...
   $sStyleReadInp_nome_ = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['nome_']) && $this->nmgp_cmp_readonly['nome_'] == 'on')
   {
       $bTestReadOnly = false;
...
<input type=hidden name="nome_" value="<?php echo NM_encode_input($nome_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_nome_" style="<?php echo $sStyleHidden_nome_; ?>;"><span id="id_label_nome_"><?php echo $this->nm_new_label['nome_']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_nome_" style="<?php echo $sStyleHidden_nome_; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["nome_"]) &&  $this->nmgp_cmp_readonly["nome_"] == "on") { 

 ?>
<input type=hidden name="nome_" value="<?php echo NM_encode_input($nome_) . "\">" . $nome_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_nome_" class="sc-ui-readonly-nome_" style=";<?php echo $sStyleReadLab_nome_; ?>"><?php echo NM_encode_input($this->nome_); ?></span><span id="id_read_off_nome_" style="white-space: nowrap;<?php echo $sStyleReadInp_nome_; ?>">
 <input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_nome_" type=text name="nome_" value="<?php echo NM_encode_input($nome_) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_nome__frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_nome__text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_view_list_inline']['run_iframe'] != "R")
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_aluno_view_list_inline");
 parent.scAjaxDetailHeight("form_aluno_view_list_inline", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
