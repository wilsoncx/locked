  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aluno_view_list_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome_
  function do_ajax_form_aluno_view_list_inline_validate_nome_()
  {
    var nomeCampo_nome_ = "nome_";
    var var_nome_ = scAjaxGetFieldText(nomeCampo_nome_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aluno_view_list_inline_validate_nome_(var_nome_, var_script_case_init, do_ajax_form_aluno_view_list_inline_validate_nome__cb);
  } // do_ajax_form_aluno_view_list_inline_validate_nome_

  function do_ajax_form_aluno_view_list_inline_validate_nome__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aluno_view_list_inline_validate_nome__cb

  // ---------- Validate idaluno_
  function do_ajax_form_aluno_view_list_inline_validate_idaluno_()
  {
    var nomeCampo_idaluno_ = "idaluno_";
    var var_idaluno_ = scAjaxGetFieldText(nomeCampo_idaluno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aluno_view_list_inline_validate_idaluno_(var_idaluno_, var_script_case_init, do_ajax_form_aluno_view_list_inline_validate_idaluno__cb);
  } // do_ajax_form_aluno_view_list_inline_validate_idaluno_

  function do_ajax_form_aluno_view_list_inline_validate_idaluno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aluno_view_list_inline_validate_idaluno__cb
  // ---------- Form
  function do_ajax_form_aluno_view_list_inline_submit_form()
  {
    scAjaxHideMessage();
    var var_nome_ = scAjaxGetFieldText("nome_");
    var var_idaluno_ = scAjaxGetFieldText("idaluno_");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aluno_view_list_inline_submit_form(var_nome_, var_idaluno_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_aluno_view_list_inline_submit_form_cb);
  } // do_ajax_form_aluno_view_list_inline_submit_form

  function do_ajax_form_aluno_view_list_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nome_");
      scAjaxHideErrorDisplay("idaluno_");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_aluno_view_list_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_aluno_view_list_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_aluno_view_list_inline_navigate_form(var_idaluno_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_aluno_view_list_inline_navigate_form_cb);
  } // do_ajax_form_aluno_view_list_inline_navigate_form

  function do_ajax_form_aluno_view_list_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_form_aluno_view_list_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aluno_view_list_inline_navigate_form_cb
  ...
  ajax_field_list[0] = "nome_";
  ajax_field_list[1] = "idaluno_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "nome_": {"label": "Nome", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idaluno_": {"label": "Idaluno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["nome_"][1] = "nome_";
  ajax_field_mult["idaluno_"][1] = "idaluno_";

  var ajax_field_id = {
    "nome_": new Array("hidden_field_label_nome_", "hidden_field_data_nome_")
  };
