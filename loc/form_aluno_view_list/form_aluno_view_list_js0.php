<form name="F2" method=post 
               action="form_aluno_view_list.php" 
               target="_self"> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_aluno_view_list_submit_form(y, z); 
} 
<?php
}
?>
