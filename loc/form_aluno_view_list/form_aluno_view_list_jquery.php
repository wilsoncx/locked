...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idaluno_' + iSeqRow).bind('blur', function() { sc_form_aluno_view_list_idaluno__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_aluno_view_list_idaluno__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nome_' + iSeqRow).bind('blur', function() { sc_form_aluno_view_list_nome__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_aluno_view_list_nome__onchange(this, iSeqRow) })
...
function sc_form_aluno_view_list_idaluno__onblur(oThis, iSeqRow) {
  do_ajax_form_aluno_view_list_validate_idaluno_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_aluno_view_list_idaluno__onchange(oThis, iSeqRow) {
...
function sc_form_aluno_view_list_nome__onblur(oThis, iSeqRow) {
  do_ajax_form_aluno_view_list_validate_nome_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_aluno_view_list_nome__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_foto_" + iSeqRow).fileupload({
    ...
    progress: function(e, data) {
      ...
      eval("var_ajax_img_foto_" + iSeqRow + " = '<?php echo $this->Ini->path_imag_temp; ?>/' + fileData[0].sc_random_prot");
