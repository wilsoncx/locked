  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aluno_view_list" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome_
  function do_ajax_form_aluno_view_list_validate_nome_(iNumLinha)
  {
    var nomeCampo_nome_ = "nome_" + iNumLinha;
    var var_nome_ = scAjaxGetFieldText(nomeCampo_nome_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aluno_view_list_validate_nome_(var_nome_, iNumLinha, var_script_case_init, do_ajax_form_aluno_view_list_validate_nome__cb);
  } // do_ajax_form_aluno_view_list_validate_nome_

  function do_ajax_form_aluno_view_list_validate_nome__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aluno_view_list_validate_nome__cb

  // ---------- Validate idaluno_
  function do_ajax_form_aluno_view_list_validate_idaluno_(iNumLinha)
  {
    var nomeCampo_idaluno_ = "idaluno_" + iNumLinha;
    var var_idaluno_ = scAjaxGetFieldHidden(nomeCampo_idaluno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aluno_view_list_validate_idaluno_(var_idaluno_, iNumLinha, var_script_case_init, do_ajax_form_aluno_view_list_validate_idaluno__cb);
  } // do_ajax_form_aluno_view_list_validate_idaluno_

  function do_ajax_form_aluno_view_list_validate_idaluno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idaluno_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idaluno_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idaluno_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idaluno_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aluno_view_list_validate_idaluno__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_aluno_view_list_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_aluno_view_list_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aluno_view_list_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_aluno_view_list_add_new_line_cb);
  } // do_ajax_form_aluno_view_list_add_new_line

  function do_ajax_form_aluno_view_list_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_aluno_view_list_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_aluno_view_list_backup_line(iNumLinha)
  {
    var var_idaluno_ = scAjaxGetFieldHidden("idaluno_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aluno_view_list_backup_line(var_idaluno_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_aluno_view_list_backup_line_cb);
  } // do_ajax_form_aluno_view_list_backup_line

  function do_ajax_form_aluno_view_list_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_aluno_view_list_backup_line_cb

  function do_ajax_form_aluno_view_list_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_aluno_view_list_cancel_insert

  function do_ajax_form_aluno_view_list_cancel_update(iSeqVert)
  {
    do_ajax_form_aluno_view_list_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_aluno_view_list_cancel_update

  function do_ajax_form_aluno_view_list_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_aluno_view_list_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_aluno_view_list_table_refresh()
  {
    var var_idaluno_ = document.F2.idaluno_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    var var_nmgp_ordem = document.F2.nmgp_ordem.value;
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aluno_view_list_table_refresh(var_idaluno_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_aluno_view_list_table_refresh_cb);
  } //  do_ajax_form_aluno_view_list_table_refresh

  function do_ajax_form_aluno_view_list_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.idaluno_.value = scAjaxGetKeyValue("idaluno_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_aluno_view_list_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_aluno_view_list_submit_form(iNumLinha, indexTR)
  {
...
?>
    x_ajax_form_aluno_view_list_submit_form(var_nome_, var_idaluno_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_aluno_view_list_submit_form_cb);
  } // do_ajax_form_aluno_view_list_submit_form

  function do_ajax_form_aluno_view_list_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idaluno_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_aluno_view_list_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_aluno_view_list_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_aluno_view_list_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idaluno_" + iNavForm);
    }
    var var_idaluno_ = document.F2.idaluno_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aluno_view_list_navigate_form(var_idaluno_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_aluno_view_list_navigate_form_cb);
  } // do_ajax_form_aluno_view_list_navigate_form

  function do_ajax_form_aluno_view_list_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idaluno_.value = scAjaxGetKeyValue("idaluno_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_aluno_view_list_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idaluno_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["idaluno_" + iNumLinha] = {"label": "Idaluno<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["nome_"][iNumLinha] = "nome_" + iNumLinha;
    ajax_field_mult["idaluno_"][iNumLinha] = "idaluno_" + iNumLinha;
    ...
    ajax_error_count["idaluno_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["nome_" + iNumLinha] = "off";
    ajax_read_only["idaluno_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idaluno_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idaluno_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idaluno_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idaluno_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idaluno_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idaluno_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idaluno_'])) ? $this->nmgp_cmp_readonly['idaluno_'] : 'on';
?>
    scAjaxFieldRead("idaluno_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("nome_" + iSeq, "on");
    scAjaxFieldRead("idaluno_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nome_" + iRow] || "on" == ajax_error_count["idaluno_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_idaluno_" + iRow))
        document.getElementById("hidden_field_data_idaluno_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nome_" + iRow] && "off" == ajax_error_count["idaluno_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nome_" + iRow] = "off";
        ajax_error_count["idaluno_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_idaluno_" + iRow))
        document.getElementById("hidden_field_data_idaluno_" + iRow).className = sCssLine;
    }
  }
