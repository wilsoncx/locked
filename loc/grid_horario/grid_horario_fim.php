...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Locked_____grid_horario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Locked_____grid_horario"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_horario'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_horario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_horario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_horario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_horario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_horario']['sc_modal']);
