  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_horario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_horario_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_h_saida_cond = scAjaxGetFieldSelect("h_saida_cond");
    var var_h_saida_hor = scAjaxGetFieldText("h_saida_hor");
    var var_h_saida_min = scAjaxGetFieldText("h_saida_min");
    var var_h_saida_seg = scAjaxGetFieldText("h_saida_seg");
    var var_idhorario_cond = scAjaxGetFieldSelect("idhorario_cond");
    var var_idhorario = scAjaxGetFieldText("idhorario");
    var var_dia_cond = scAjaxGetFieldSelect("dia_cond");
    var var_dia = scAjaxGetFieldText("dia");
    var var_h_entrada_cond = scAjaxGetFieldSelect("h_entrada_cond");
    var var_h_entrada_hor = scAjaxGetFieldText("h_entrada_hor");
    var var_h_entrada_min = scAjaxGetFieldText("h_entrada_min");
    var var_h_entrada_seg = scAjaxGetFieldText("h_entrada_seg");
    ...
    x_grid_horario_ajax_save_filter( var_h_saida_cond, var_h_saida_hor, var_h_saida_min, var_h_saida_seg, var_idhorario_cond, var_idhorario, var_dia_cond, var_dia, var_h_entrada_cond, var_h_entrada_hor, var_h_entrada_min, var_h_entrada_seg, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_horario_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_horario_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_horario_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_horario_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_horario_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_horario_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_horario_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_horario_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_horario_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_horario_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "h_saida";
  ajax_field_list[1] = "idhorario";
  ajax_field_list[2] = "dia";
  ajax_field_list[3] = "h_entrada";

  var ajax_error_list = {
    "h_saida": {"label": "H Saida", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "idhorario": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "dia": {"label": "Dia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "h_entrada": {"label": "H Entrada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
