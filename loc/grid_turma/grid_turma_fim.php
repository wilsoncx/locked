...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Locked_____grid_turma"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Locked_____grid_turma"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_turma'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_turma']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_turma']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_turma']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_turma']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_turma']['sc_modal']);
