  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_turma" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_turma_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_idturma_cond = scAjaxGetFieldSelect("idturma_cond");
    var var_idturma = scAjaxGetFieldText("idturma");
    var var_turno_cond = scAjaxGetFieldSelect("turno_cond");
    ...
    x_grid_turma_ajax_save_filter( var_idturma_cond, var_idturma, var_turno_cond, var_turno, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_turma_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_turma_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_turma_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_turma_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_turma_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_turma_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_turma_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_turma_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_turma_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_turma_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "turno";

  var ajax_error_list = {
    "idturma": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "turno": {"label": "Turno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
