...
$oExportPdf = new grid_turma_export_pdf;
$oExportPdf->exportPdf();

class grid_turma_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - turma :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_turma_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_turma']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_turma']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_turma.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_turma']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_turma']['pdf_name'] : "grid_turma.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="grid_turma.php" target="<?php echo $NM_target; ?>" style="display: none"> 
